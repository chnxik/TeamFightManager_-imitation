...
#pragma region Create Object for this Scene
		// GameObject
		{
			...
			// Stadium Chair
			GameObject* Stadium_Chair = Instantiate<GameObject>(Vector3(0.0f, -133.f, 1.03f), Vector3(1197.f, 143.f, 1.f), eLayerType::BackGround);
			Stadium_Chair->SetName(L"StadiumChair");
			Stadium_Chair->AddComponent<MeshRenderer>()->SetMeshRenderer(L"RectMesh", L"Stadium_chairMt");
			
			 // Stadium Desk
			 GameObject* Stadium_desk = Instantiate<GameObject>(Vector3(0.0f, -161.f, 1.02f), Vector3(1273.f, 141.f, 1.f), eLayerType::BackGround);
			 Stadium_desk->SetName(L"StadiumDesk");
			 Stadium_desk->AddComponent<MeshRenderer>()->SetMeshRenderer(L"RectMesh", L"Stadium_deskMt");
			 
			 // Stadium frame
			 GameObject* Stadium_frame = Instantiate<GameObject>(Vector3(0.0f, -118.f, 1.04f), Vector3(1735.f, 200.f, 1.f), eLayerType::BackGround);
			 Stadium_frame->SetName(L"StadiumFrame");
			 Stadium_frame->AddComponent<MeshRenderer>()->SetMeshRenderer(L"RectMesh", L"Stadium_frameMt");
			 
			 // Stadium frame front
			 GameObject* Stadium_frame_front = Instantiate<GameObject>(Vector3(0.0f, -250.f, 1.01f), Vector3(1768.f, 80.f, 1.f), eLayerType::BackGround);
			 ...
			 // Stadium frame Bg
			 GameObject* Stadium_frame_Bg = Instantiate<GameObject>(Vector3(0.0f, -118.f, 1.05f), Vector3(1252.f, 160.f, 1.f), eLayerType::BackGround);

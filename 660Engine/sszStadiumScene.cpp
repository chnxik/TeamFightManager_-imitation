...
#pragma region Create Object for this Scene
		// GameObject
		{
			...
			Stadium_Chair->GetComponent<Transform>()->SetPosition(Vector3(0.0f, 0.0f, 1.03f));
			Stadium_Chair->GetComponent<Transform>()->SetScale(Vector3(0.3f, 0.036f, 1.f));
			 ...
			 Stadium_desk->GetComponent<Transform>()->SetPosition(Vector3(0.0f, 0.0f, 1.02f));
			 Stadium_desk->GetComponent<Transform>()->SetScale(Vector3(0.318f, 0.035f, 1.f));
			 ...
			 Stadium_frame->GetComponent<Transform>()->SetPosition(Vector3(0.0f, 0.0f, 1.04f));
			 Stadium_frame->GetComponent<Transform>()->SetScale(Vector3(0.434f, 0.05f, 1.f));
